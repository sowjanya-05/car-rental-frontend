...
const Chatwidget = () => {
  ...
  const handleNewUserMessage = (newMessage) => {
    ...
    if (
      ...
      addResponseMessage(
        `You can send your number here or can directly contact the owner via 7013249587,8555068572,8008049201`
      );
      ...
      addResponseMessage(
        `Sorry, I'm currently learning your language. I don't know the answer. Please contact on this numbers 7013249587,8555068572,9705569936,9989411297`
      );
    }
  };
  return (
